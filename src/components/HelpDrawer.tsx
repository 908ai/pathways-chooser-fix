  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerTrigger asChild>
        <Button
          variant="default"
          className="fixed bottom-6 right-6 h-10 w-10 rounded-full shadow-lg bg-primary text-primary-foreground hover:bg-primary/90 z-50 transform hover:scale-110 transition-transform duration-200 flex items-center justify-center"
        >
