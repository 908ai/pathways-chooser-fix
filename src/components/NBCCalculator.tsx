  ...
  const handleSaveDraft = async (isIncrementalSave = false) => {
    ...
    try {
      ...
      const draftData = {
        ...
        has_cathedral_or_flat_roof: selections.hasCathedralOrFlatRoof || selections.hasCathedralOrFlatRoofSelection,
        cathedral_flat_rsi: selections.cathedralFlatRSIValue || selections.cathedralFlatRSI,
        floors_garage_rsi: parseFloat(selections.floorsGarageRSI || selections.floorsOverGarageRSI) || null,
        has_skylights: selections.hasSkylights,
        skylight_u_value: selections.skylightUValue,
        has_in_floor_heat: selections.hasInFloorHeat,
        floors_slabs_selected: Array.isArray(selections.floorsSlabsSelected) ? selections.floorsSlabsSelected : (selections.floorsSlabsSelected ? [selections.floorsSlabsSelected] : []),
