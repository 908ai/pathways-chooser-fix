...
-- Create function to insert project summary with correct data types
CREATE OR REPLACE FUNCTION public.insert_project_summary(
  ...
  p_window_u_value NUMERIC,  -- Changed from TEXT to NUMERIC
