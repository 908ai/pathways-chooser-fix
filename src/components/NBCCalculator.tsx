...
const NBCCalculator = () => {
    ...
    try {
      ...
      if (p) {
        ...
        const newSelections = {
          ...
          airtightnessTestType: p.airtightness_test_type || "",
          customAirtightness: "",
  ...
  const validateStep1 = () => {
    const { firstName, lastName, company, phoneNumber, streetAddress, city, buildingType, province, climateZone, companyAddress } = selections;
