    ...
    return (
        <WarningButton title="Effective RSI/R-Value Required">
            <div className="space-y-3">
                ...
                <p>
                    Supporting documentation (such as results from the <a href="https://natural-resources.canada.ca/energy-efficiency/energy-star/tables-calculating-effective-thermal-resistance-opaque-assemblies" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">NRCan RSI tables</a> or the <a href="https://cwc.ca/design-tool/effectiver/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">Canadian Wood Council calculator</a>) must be included in your design drawings and specifications.
                </p>
                <p>
                ...
                <div className="pt-2">
                    <a href="/find-a-provider" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800 text-sm inline-flex items-center gap-1">
