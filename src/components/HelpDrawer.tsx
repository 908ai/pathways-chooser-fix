                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <ul className="list-disc ml-6 space-y-1 text-muted-foreground">
                      ...
                      <li>
                        Look for the "More Info" icons{" "}
                        <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-orange-500 align-middle mx-1">
                          <Info className="h-6 w-6 stroke-white" />
                        </span>
                        to learn more about how each option affects your project. If you see a warning ⚠️
                        or info icon ℹ️, click it to view important details or additional information
                  ...
                  <div>
                    <h5 className="font-medium text-foreground mb-2 text-base">2. When should I start this application?</h5>
                    <p className="ml-6 text-muted-foreground">The best time to use Energy Navigator is at the design stage, before drawings are finalized. This gives builders room to adjust insulation levels, mechanical options, or air-sealing targets without costly revisions later.</p>
                  </div>

                  <div>
                    <h5 className="font-medium text-foreground mb-2 text-base">3. Enter Your Building Details:</h5>
                    <ul className="list-disc ml-6 space-y-1 text-muted-foreground">
                  ...
                  <div>
                    <h5 className="font-medium text-foreground mb-2 text-base">4. Understand What You'll See:</h5>
                    <ul className="list-disc ml-6 space-y-1 text-muted-foreground">
                  ...
                  <div>
                    <h5 className="font-medium text-foreground mb-2 text-base">5. Additional information required for all pathways:</h5>
                    <ul className="list-disc ml-6 space-y-1 text-muted-foreground">
                  ...
                  <div>
                    <h5 className="font-medium text-foreground mb-2 text-base">6. Need Help?</h5>
                    <ul className="list-disc ml-6 space-y-1 text-muted-foreground">
