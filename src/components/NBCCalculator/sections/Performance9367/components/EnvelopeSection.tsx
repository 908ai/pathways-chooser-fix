...
export default function EnvelopeSection({
    ...
    isMissing,
    missingFieldClass,
    isHeatedFloorsChecked,
    isUnheatedFloorChecked,
    isSlabOnGradeChecked,
}: {
    selections: any;
    setSelections: any;
    ...
    isHeatedFloorsChecked: boolean;
    isUnheatedFloorChecked: boolean;
    isSlabOnGradeChecked: boolean;
}) {
    return (
