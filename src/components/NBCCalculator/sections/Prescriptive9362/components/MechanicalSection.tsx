...
export function MechanicalSection({
    ...
    return (
        <div className="space-y-4">
            ...
            {selections.coolingApplicable === "yes" && !(selections.heatingType === 'heat-pump' && selections.heatingEfficiency && selections.heatingEfficiency !== 'Other') && (
