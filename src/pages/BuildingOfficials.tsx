    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-foreground">For Building Officials</h1>
        ...
        <Card className="bg-card shadow-sm rounded-lg">
          <CardContent className="p-6 space-y-6 text-muted-foreground">
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg dark:bg-green-900/30 dark:border-green-500/50">
              <h3 className="text-lg font-semibold text-green-800 dark:text-green-300 mb-4">How Do Building Officials Benefit From This Tool?</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="h-2 w-2 bg-green-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div>
                    <p className="font-medium text-foreground mb-1">Clear, jurisdiction-ready documentation:</p>
                ...
                <div className="flex items-start gap-3">
                  <div className="h-2 w-2 bg-green-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div>
                    <p className="font-medium text-foreground mb-1">Simplified review process:</p>
                ...
                <div className="flex items-start gap-3">
                  <div className="h-2 w-2 bg-green-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div>
                    <p className="font-medium text-foreground mb-1">Confidence in verification:</p>
                ...
                <div className="flex items-start gap-3">
                  <div className="h-2 w-2 bg-green-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div>
                    <p className="font-medium text-foreground mb-1">Consistent interpretation:</p>
                ...
                <div className="flex items-start gap-3">
                  <div className="h-2 w-2 bg-green-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div>
                    <p className="font-medium text-foreground mb-1">Fewer errors at intake:</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg dark:bg-orange-900/30 dark:border-orange-500/50">
                <h3 className="text-lg font-semibold text-orange-800 dark:text-orange-300 mb-4">Performance Path</h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="h-1.5 w-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></div>
                    <p className="text-sm text-muted-foreground">A Proposed House is created using your building plans, envelope specifications and mechanical systems.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="h-1.5 w-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></div>
                    <p className="text-sm text-muted-foreground">A Reference House is generated based on the Proposed House and NBC2020's minimum requirements.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="h-1.5 w-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></div>
              ...
              <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg dark:bg-purple-900/30 dark:border-purple-500/50">
                <h3 className="text-lg font-semibold text-purple-800 dark:text-purple-300 mb-4">Prescriptive Path</h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
            ...
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg dark:bg-red-900/30 dark:border-red-500/50">
              <h3 className="text-lg font-semibold text-red-800 dark:text-red-300 mb-4">Builder Responsibilities</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
