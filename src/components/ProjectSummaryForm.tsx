  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const projectData = {
        ...
        // Envelope Specific Logic (matching EnvelopeSection fields)
        ...
        floors_over_garage_rsi: parseFloat(selections.floorsGarageRSI || selections.floorsOverGarageRSI) || null,
        slab_insulation_type: selections.slabInsulation,
        slab_insulation_value: parseFloat(selections.slabInsulationValue) || null,
        in_floor_heat_rsi: parseFloat(selections.inFloorHeatRSI || selections.heatedFloorsRSI) || null,
        slab_on_grade_rsi: parseFloat(selections.slabOnGradeRSI) || null,
        slab_on_grade_integral_footing_rsi: parseFloat(selections.slabOnGradeIntegralFootingRSI || selections.slabOnGradeRSI) || null,
        ...
        heated_floors_rsi: parseFloat(selections.heatedFloorsRSI || selections.inFloorHeatRSI) || null,
