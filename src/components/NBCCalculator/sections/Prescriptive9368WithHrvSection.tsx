...
export const Prescriptive9368WithHrvSection: React.FC<Props> = ({ selections, setSelections, WarningButton }) => {
    ...
    const InfoCollapsible = ({
        ...
        return (
            <Collapsible open={isOpen} onOpenChange={setIsOpen} className={`p-2 border ${borderColor} ${bgColor} rounded-lg`}>
                ...
                <CollapsibleContent className="mt-4 data-[state=open]:animate-collapsible-down data-[state=closed]:animate-collapsible-up overflow-hidden">
                    <div className={`text-xs ${contentColor}`}>{children}</div>
                </CollapsibleContent>
            </Collapsible>
        );
    };
            ...
            {<>
                <div className="space-y-2">
                    ...
                    <Select value={selections.hasF280Calculation} onValueChange={value => setSelections(prev => ({
                        ...
                        <SelectTrigger className="bg-white border-slate-300 text-slate-900 placeholder:text-slate-500 focus:ring-primary">
                ...
                {selections.hasCathedralOrFlatRoof === "yes" && <div className="space-y-2">
                    ...
                    }))} className="bg-white border-slate-300 text-slate-900 placeholder:text-slate-500 focus:ring-primary" />
                    {(() => {
                        const minRSI = 5.02;
                ...
                <div className="space-y-2">
                    ...
                    {selections.floorsUnheatedRSI && parseFloat(selections.floorsUnheatedRSI) < 5.02 && <div className="p-3 bg-red-50 border border-red-200 rounded-md">
                ...
                <div className="space-y-2">
                    ...
                    {selections.floorsGarageRSI && parseFloat(selections.floorsGarageRSI) < 4.86 && <div className="p-3 bg-red-50 border border-red-200 rounded-md">
                        <p className="text-sm text-red-800 font-medium">
                            ⚠️ Effective RSI/R-Value Required
                        </p>
                        <p className="text-sm text-red-700 mt-1">
                    ...
                    <InfoCollapsible title="⚠️ Caution: Choosing Airtightness Points Without Experience">
                        <div className="text-xs text-slate-600 space-y-2">
                            ...
                            <div className="flex items-center gap-1 text-sm mt-3">
                                <span>🔗</span>
                                <a href="https://www.solinvictusenergyservices.com/airtightness" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-yellow-300">
                                    More information
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="space-y-3 pt-4 border-t border-border/20">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <label htmlFor="midConstructionBlowerDoor-9367" className="text-sm font-medium cursor-pointer text-slate-900">
                        ...
                        <InfoCollapsible title="ℹ️ Benefits of Mid-Construction Blower Door Testing">
                            <div className="text-xs text-slate-600 space-y-2">
                                ...
                                <div className="flex items-center gap-1 text-sm mt-3">
                                    <span>📄</span>
                                    <a href="https://static1.squarespace.com/static/5659e586e4b0f60cdbb0acdb/t/6740da3ccee315629895c31b/1732303420707/Blower+Door+Checklist.pdf" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-yellow-300/80">
                                        View the Blower Door Checklist
                                    </a>  
                                </div>
                                <div className="flex items-center gap-1 text-sm mt-3">
                                    <span>▶️</span>
                                    <a href="https://www.youtube.com/watch?v=4KtCansnpLE" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-yellow-300/80">
