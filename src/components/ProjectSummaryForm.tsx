...
const ProjectSummaryForm = ({ 
  ...
  const handleSave = async () => {
    if (!user) {
      toast.error("Authentication Required", { description: "Please sign in to save." });
      return;
    }
    if (!projectName) {
      toast.error("Project Name Required", { description: "Please enter a project name." });
      return;
    }
    ...
    try {
      ...
      toast.success("Project Submitted", { description: "Your project has been successfully submitted for review." });
      onSave?.();
