...
const HelpDrawer = ({ open, onOpenChange }: HelpDrawerProps) => {
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      ...
      <DrawerContent className="bg-slate-50 text-slate-900 border-t border-slate-200">
        <div className="mx-auto w-full max-w-4xl relative">
          <DrawerHeader>
            <DrawerTitle className="text-2xl font-bold text-center text-slate-900">
          ...
          <DrawerClose asChild>
            <Button
              variant="ghost"
              className="absolute top-3 right-3 rounded-full h-8 w-8 p-0 text-slate-500 hover:text-slate-900 hover:bg-slate-100"
            >
              <X className="h-4 w-4" />
              <span className="sr-only">Close</span>
            </Button>
          </DrawerClose>
          <div className="p-4 pb-8 text-slate-600 max-h-[80vh] overflow-y-auto">
            <div className="space-y-4 text-sm">
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-slate-900 text-base">Please follow these instructions:</h4>
                
                <div className="space-y-3">
                  <div>
                    <h5 className="font-medium text-slate-900 mb-2 text-base">1. Choose Your Code Pathway:</h5>
                  ...
                  <div>
                    <h5 className="font-medium text-slate-900 mb-2 text-base">2. Enter Your Building Details:</h5>
                    <ul className="list-disc ml-6 space-y-1 text-slate-600">
                  ...
                  <div>
                    <h5 className="font-medium text-slate-900 mb-2 text-base">3. Understand What You'll See:</h5>
                     <ul className="list-disc ml-6 space-y-1 text-slate-600">
                  ...
                  <div>
                    <h5 className="font-medium text-slate-900 mb-2 text-base">4. Need Help?</h5>
                    <ul className="list-disc ml-6 space-y-1 text-slate-600">
